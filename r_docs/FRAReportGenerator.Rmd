...
final_build_fun <- function() {
  ...
  source("r_docs/R/background_facts_med_hx_final_build.R")
  ...
  doc %>%
    ...
    print(target = paste0(final_doc_path, ".docx"))
  
  # open newly created document
  system(paste0("open \"", as.character(final_doc_path), ".docx", "\""))
}
